...
class Add_quotation(Base):
    ...
    client=(By.XPATH,"//h6[normalize-space()='Ashish kumar khade']")
    ...
    upload_file=(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/div[1]/main[1]/div[1]/div[2]/div[2]/form[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]")
    image=(By.CLASS_NAME,"upload-input draggable")
    ...
    def add_quotation(self):
        ...
        file=self.EF.find_element(self.upload_file)
        file.click()
        time.sleep(3)
